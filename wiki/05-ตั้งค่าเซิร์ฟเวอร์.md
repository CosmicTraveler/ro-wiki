...
**ตัวอย่าง แก้ไข inter-server.conf**{: style="color: red;" }

![](../assets/images/img/05/15.PNG)

> บรรทัดที่ 6 คือ user ของ mySQL ที่ถูกสร้าง\
> บรรทัดที่ 7 คือ password ของ user ที่ถูกสร้าง (บรรทัดข้างบน)\
> บรรทัดที่ 8 ชื่อก้อน database ที่ถูกสร้าง ดูดวิธีการได้จากหัวข้อ [ตั้งค่า mySQL](https://cosmictraveler.github.io/ro-wiki/04-ตั้งค่าmysql){:target="_blank"}
